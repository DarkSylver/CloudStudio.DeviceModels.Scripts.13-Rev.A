...
e96.variableTypeId = 1306;
    ...
    var alert_temp = e.addAlert();

    alert_temp.variableTypeId = 1306;
    alert_temp.conditionType = conditionType.lowerOrEqual;
    alert_temp.threshold = 0;
    alert_temp.normalConditionType = conditionType.higher;
    alert_temp.normalThreshold = 0;
    alert_temp.severity = 1;
